...
const PComponent: React.FC<Cards> = ({
  ...
  return (
    <m.div
      className="sm:relative flex h-auto w-auto flex-col justify-center items-center"
      id={id}
      initial={{ x: "-100vw" }}
      animate={{ x: 0 }}
      transition={{ type: "spring", duration: 1, bounce: 0.3 }}>
      <div className="flex flex-col justify-center item-center cursor-pointer rounded-2xl border border-paleGray-100">
        <Image
