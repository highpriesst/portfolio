  ...
  return (
    <m.div className="bg-gray-900 min-h-screen">
      ...
      <div className="relative w-full h-full z-0">
        ...
        <h1 className="text-3xl text-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pl-10">
          Welcome!
        </h1>
        <button className="bg-gray-300 text-white w-12 h-12 rounded-full animate-bounce bg-transparent absolute left-1/2 bottom-0">
          <ArrowDownCircleIcon />
        </button>
      </div>
