      ...
      <div className="h-screen flex justify-center items-center bg-white dark:bg-gray-900">
        <div className="flex flex-col max-w-[800px] h-[400px] tracking-widest">
          <p>
            ...
            back in 2014 when I decided to try editing custom Tumblr themes —
            turns out hacking together a custom reblog button taught me a lot
            about HTML &amp; CSS! With a strong foundation in HTML, CSS, and
            JavaScript, and also React/Typescript.I bring ideas to life
            through&#160;
            ...
            development needs. I am excited to work with you and bring your
            ideas to life.
          </p>
